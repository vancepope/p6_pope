...
import { Platform, NavController, MenuController, Alert, AlertController } from 'ionic-angular';
...
export class MyApp {
  ...
  constructor(private menuCtrl: MenuController, platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen, private authService: AuthService) {
    firebase.initializeApp({
      apiKey: "AIzaSyCLaO4ACrXGXH_14DK68yAKZeYROyYacd8",
      authDomain: "p6pope.firebaseapp.com"
    });
